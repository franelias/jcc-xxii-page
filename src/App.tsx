...
const App = () => {
  return (
    <Layout style={{ fontFamily: "Reddit sans" }}>
      ...
      >
        Facultad de Ciencias Exactas, Ingeniería y Agrimensura. Av. Pellegrini 250, Rosario, Santa Fe, República Argentina. Teléfono: (+54) 0341- 4802649
      </Footer>
    </Layout>
  )
}
